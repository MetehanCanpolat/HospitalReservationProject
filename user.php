  ...
  <header>
    ...
    <nav class="navigation">
      ...
      <?php
         ...
         /*
         $query = "SELECT * FROM hastalar WHERE hastatc=$tc";
  ...
  <section class="login-frame">
    <div class="wrapper" object-visible>
      ...
      <div class="container">
        ...
        <label for="isimsoyisim">Hasta Adı Soyadı: <?php echo "$isim $soyisim"; ?></label>
        <label for="tc">Hasta TC no: <?php echo $tc; ?></label>
        <label for="email">Hasta email: <?php echo $email; ?></label>
        <label for="password">Hasta şifresi: <?php echo $password; ?></label>
        <br />
